      ...
      <AuthContextComponent>
        ...
        <Routes>
          ...
          <Route
            ...
            element={<ProtectedTeacherRouter Component={CreatePractice} />}
          />
          <Route
            path="/profile"
            element={<ProtectedUserRouter Component={Profile} />}
          />
          <Route path="/practice" element={<Practice />} />
          <Route
            path="/order/my-orders"
            element={<ProtectedUserRouter Component={MyOrders} />}
          />
          ...
          <Route
            path="/user/email-verification/:userId/:uniqueString"
