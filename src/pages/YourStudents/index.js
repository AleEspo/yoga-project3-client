...
export function YourStudents() {
  ...
  useEffect(() => {
    async function fetchStudents() {
      try {
        const response = await api.get("/your-students");
      ...
      {filteredStudents && (
        <div className="container my-24 px-6 mx-auto" id="latest-classes">
          ...
          <section className="mb-32 text-gray-800 text-center md:text-left">
            ...
            <SearchBar
              filteredFunction={filteredStudents}
              allPractices={students}
              className="mb-40"
            />

            {filteredStudents.map((currentTeacher) => {
              return (
                <div className="my-24 flex flex-wrap mb-6">
                  ...
                  <div className="grow-0 shrink-0 basis-auto w-full md:w-9/12 xl:w-7/12 px-3 mb-6 md:mb-0 mr-auto">
                    ...
                    <p className="text-gray-500 mb-6">
                      <small>
                        Published <u>{currentTeacher.createdAt}</u> by
